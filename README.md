...
api/v1/getTransactions: will provide details all transactions of all customers stored in database
api/v1/saveTransaction: will facilitate to store the transaction details that is performed into database
